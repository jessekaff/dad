---
description: Product Planning Rules for Development Accelerator Documentation (DAD)
globs:
alwaysApply: false
version: 4.0
encoding: UTF-8
...
<fallback_sequence> 1. @.dad/standards/tech-stack.md 2. @CLAUDE.md 3. Cursor User Rules
</fallback_sequence>
</data_sources>
...
Use the file-creator subagent to create the file: .dad/product/mission.md and use the following template:
...
Use the file-creator subagent to create the file: .dad/product/tech-stack.md and use the following template:
...
<then_check> 1. @.dad/standards/tech-stack.md 2. @CLAUDE.md 3. Cursor User Rules
</then_check>
...
Use the file-creator subagent to create the file: .dad/product/mission-lite.md for the purpose of establishing a condensed mission for efficient AI context usage.
...
Use the file-creator subagent to create the following file: .dad/product/roadmap.md using the following template:
...
Use the file-creator subagent to create the file: .dad/product/decisions.md using the following template:
...
<final_checklist>
<verify> - [ ] All 5 files created in .dad/product/ - [ ] User inputs incorporated throughout - [ ] Missing tech stack items requested - [ ] Initial decisions documented
</verify>
</final_checklist>
